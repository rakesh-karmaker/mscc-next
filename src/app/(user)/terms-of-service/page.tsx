      ...
      <div className="terms-container">
        <KeyPoints
          content={content.map((item) => ({
            ...item,
            list:
              item.list?.map((element) => element.props.children) || undefined,
          }))}
        />
        <TermsPolicyContent
          content={content.map((item) => ({
...
const content = [
  ...
  },
  {
    ...
    list: [
      <p key="user-conduct-1">Post or share inappropriate, offensive, or illegal content.</p>,
      <p key="user-conduct-2">Attempt to access unauthorized areas of the site.</p>,
      <p key="user-conduct-3">Violate the privacy of other users.</p>,
    ],
  },
  {
