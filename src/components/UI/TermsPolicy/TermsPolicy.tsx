...
const TermsPolicyContent = ({ content, page }:  TermsPolicyContentProps) => {
  return (
...
const TermsPolicyItem = ({ title, content, list, index, id }: {title: string, content: string, list?: string[] | React.ReactNode[], index: number, id:string}) => {
  return (
...
const KeyPoints = ({ content }: Omit<TermsPolicyContentProps, ("page")>) => {
  return (
